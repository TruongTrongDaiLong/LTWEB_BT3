...
@MultipartConfig
@WebServlet(urlPatterns = {"/manager/updateprofile"})
public class UpdateprofileController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = req.getRequestDispatcher("/view/manager/updateprofile.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		 try {
             ...
             req.getRequestDispatcher("/view/manager/updateprofile.jsp").forward(req, resp);
         }
	}
}
