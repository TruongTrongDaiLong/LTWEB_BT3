...
public class DBConnectSQL {
    private final String serverName = "LAPTOP-87CNGKV0\\SQLEXPRESS01";
    private final String dbName = "ltwt4";
    ...
    private final String password = "123456";  // Ensure this is correct
