...
<body>
    ...
    <div class="container">
        ...
        <form action="<%=request.getContextPath()%>/manager/updateprofile" method="post" enctype="multipart/form-data">
    ...
    <input type="file" id="images" name="images" class="form-control-file" onchange="previewImage(event)">
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" value="<%= request.getAttribute("username") %>" class="form-control" readonly>
            </div>

            <div class="form-group">
                <label for="email">Email:</label>
                <input type="email" id="email" name="email" value="<%= request.getAttribute("email") %>" class="form-control" readonly>
            </div>
